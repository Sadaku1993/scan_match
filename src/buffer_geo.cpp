...
float offset_dyaw = 0.0016;//tsukuba_all
double dist = 0.0;
...
//	ros::Rate r(100*hosei);
	...
	//		oS(1,3) = odom_v * dt;
			...
			//aS = calcMat(pitchrate*dt, rollrate*dt, azm_yaw*dt);//ark:calcMat <== #include<scan_match/util.h> <--use rpy2mat() 
